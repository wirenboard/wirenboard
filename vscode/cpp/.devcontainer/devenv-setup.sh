...
schroot -c bullseye-amd64-sbuild --directory=/ -- apt-get -y install libwbmqtt1-4:armhf libwbmqtt1-4-dev:armhf libwbmqtt1-4-test-utils:armhf j2cli:all gdbserver:armhf lcov
