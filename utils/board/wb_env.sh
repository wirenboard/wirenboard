...
case "$WB_VERSION" in
    ...
    export WB_ADC_TYPE WB_GPIO_MUX_A WB_GPIO_MUX_B WB_GPIO_MUX_C \
        ...
        WB_GPIO_W1 WB_GPIO_W2 WB_GPIO_W3 WB_PWM_BUZZER
...
#    WB_GPIO_NRF_EN=37;
    ...
    export WB_ADC_TYPE WB_GPIO_RFM_IRQ WB_RFM_SPI_MINOR WB_GSM_POWER_TYPE WB_GPIO_GSM_POWER WB_GPIO_GSM_POWER WB_GPIO_GSM_PWRKEY  WB_GPIO_GSM_STATUS WB_PWM_BUZZER
    ...
    export  WB_ADC_TYPE WB_GSM_POWER_TYPE WB_GPIO_GSM_RESET \
    ...
    export WB_GPIO_MUX_A WB_GPIO_MUX_B WB_GPIO_MUX_C \
