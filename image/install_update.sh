...
# This is a default install_update.sh which is used when
# there is no install_update.sh provided with a rootfs image.
#
# If you want to modify FIT installation procedure, please consider
# patching install_update.sh in wb-utils package.
#
# PLEASE DO NOT EDIT THIS FILE UNTIL YOU KNOW WHAT YOU ARE DOING.
